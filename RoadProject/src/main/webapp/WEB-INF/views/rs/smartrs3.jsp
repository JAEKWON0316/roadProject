...
cal_btn.addEventListener('click', function() {
    ...
    const popup = window.open("rsCalendar3", "CalendarPopup", "width=800,height=700,scrollbars=yes,resizable=yes");
    ...
    if (popup) {
        popup.onload = function() {
            ...
            console.log("로컬 스토리지에서 가져온 날짜:", storedDate);
            const dateInput = popup.document.getElementById("dateInput");
            if (dateInput) {
                dateInput.value = storedDate; // 값 설정
            } else {
...
dropdownIcon.addEventListener('click', function() {
    const popup = window.open("timeselect4", "CalendarPopup", "width=840,height=700,scrollbars=yes,resizable=yes");
...
document.querySelector('.theme_cho').addEventListener('click', function() {
    const popup = window.open("kwselect2", "KeywordSelectPopup", "width=800,height=700,scrollbars=yes,resizable=yes");

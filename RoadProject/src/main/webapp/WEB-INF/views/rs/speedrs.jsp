...
<div id="rscontainer">
        ...
        <!-- 선택창 박스 -->
        <form action="speedrs2" method="POST">
        <div class="input_box">
            <div class="day">
                <p>이용일 <span>*</span></p>
                <div class="day_box">
...
cal_btn.addEventListener('click', function() {
    const popup = window.open("rsCalendar", "CalendarPopup", "width=800,height=700,scrollbars=yes,resizable=yes");
...
document.querySelector('form').addEventListener('submit', function(event) {
    ...
    if (!dateInput || !timeInput || !agreeCheckbox) {
        event.preventDefault(); // 폼 제출 중단
        console.log("1. "+dateInput+", 2. "+timeInput);
    } else {
    	console.log("1. "+dateInput+", 2. "+timeInput);
    }
});

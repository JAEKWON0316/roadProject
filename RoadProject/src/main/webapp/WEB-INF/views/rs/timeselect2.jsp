 ...
 <div id="time_select">
        ...
        <div class="subtitle">
         ...
         <form action="saveTime" method="post" id="timeForm">
            <ul class="time_list">
                <li class="disabled">10:00</li>
                <li class="disabled">11:00</li>
                <li class="disabled">12:00</li>
                <li class="disabled">13:00</li>
                <li class="disabled">14:00</li>
                <li class="disabled">15:00</li>
                <li>16:00</li>
                <li class="disabled">17:00</li>
                <li class="disabled">18:00</li>
                <li>19:00</li>
                <li>20:00</li>
                <li>21:00</li>
                <li class="disabled">22:00</li>
                <li class="disabled">23:00</li>
                <li>24:00</li>
            </ul>
...
timeListItems.forEach(item => {
    // 비활성화된 시간에 클릭 이벤트를 막음
    if (item.classList.contains('disabled')) {
        item.style.pointerEvents = 'none'; // 클릭 비활성화
        item.style.color = '#CCCCCC'; // 색상 변경 (비활성화 효과)

...
<%
    ...
    String[] selectedKeywords = request.getParameterValues("keywords"); // 여러 개의 키워드를 배열로 가져오기
    String selectedKeywordString = selectedKeywords != null ? String.join(", ", selectedKeywords) : ""; // 배열을 문자열로 변환
    ...
    System.out.println("키워드 : "+selectedKeywordString);
    
    String uname = (String) session.getAttribute("nickname");
	String uphone = (String) session.getAttribute("phone");
	System.out.println("name1 : "+uname+", uphone1 : "+uphone);
%>
<form id="reservationForm" method="post" action="speedrs_ok"> <!-- 폼 시작 -->
    <div id="rscontainer">
        <div class="div">
            <div class="content">
                <div class="div1">스피드 예약</div>
                <div class="forminput-parent">
                        ...
                        <div class="input-box">
                            <div class="input-box-token">
                                <div class="input-token">
                                    <div class="text"> <%= uname != null ? uname : "null" %></div>
                                </div>
                    ...
                    <div class="forminput1">
                        ...
                        <div class="input-box">
                            <div class="input-box-token">
                                <div class="input-token">
                                    <div class="text"><%= uphone != null ? uphone : "null" %></div>
                                </div>
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            submitButton.addEventListener('click', function(event) {
                ...
                if (isKakaoPaySelected) {
                    ...
                    window.location.href = 'speedrs_fail'; 
